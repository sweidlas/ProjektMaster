...
class Interface extends Frame implements ActionListener{
	...
	public void actionPerformed(ActionEvent event) {
		...
		if(event.getSource() == addProduct){
			userInterface.addProductInterface.AddProduct addProductInterface = new userInterface.addProductInterface.AddProduct ();
			
		} else if(event.getSource() == editCategory) {
			userInterface.changeCategory.ChangeCategory changeCategoryInterface = new userInterface.changeCategory.ChangeCategory ();
